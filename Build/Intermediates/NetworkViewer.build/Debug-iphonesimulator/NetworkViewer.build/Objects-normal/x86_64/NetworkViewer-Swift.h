...
SWIFT_MODULE_NAMESPACE_PUSH("NetworkViewer")
@class UIWindow;
@class UIApplication;

SWIFT_CLASS("_TtC13NetworkViewer11AppDelegate")
...
SWIFT_CLASS("_TtC13NetworkViewer10JsonParser")
@interface JsonParser : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC13NetworkViewer12NetworkLayer")
@interface NetworkLayer : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC13NetworkViewer9UserModel")
